...
export const seoConfigs = {
  homepage: {
    title:
      "Professional Landscaping Services in Fayetteville, AR | Cagle's Landscaping & Restoration",
    description:
      "Transform your outdoor space with expert landscaping services in Fayetteville, AR. Lawn care, landscape design, hardscaping & more. Free estimates. Call (520) 358-2221.",
    keywords: [
  ...
  services: {
    title:
      "Lawn Care & Landscaping Services in Fayetteville, AR | Cagle's Landscaping",
    description:
      "Complete landscaping services in Fayetteville and Northwest Arkansas. Lawn care, design, hardscaping, irrigation, tree care, and seasonal maintenance.",
    keywords: [
  ...
  portfolio: {
    title:
      "Landscaping Portfolio | Fayetteville, AR Projects | Cagle's Landscaping",
    description:
      "View our landscaping portfolio featuring residential and commercial projects throughout Fayetteville, Springdale, Rogers, and Bentonville, AR.",
    keywords: [
  ...
  about: {
    title:
      "About Cagle's Landscaping | Family-Owned Fayetteville, AR Landscapers",
    description:
      "Learn about Cagle's Landscaping & Restoration. Family-owned business serving Northwest Arkansas since 2015. Licensed, insured, and locally trusted.",
    keywords: [
  ...
  contact: {
    ...
    description:
      "Get your free landscaping estimate today. Serving Fayetteville, Springdale, Rogers, Bentonville. Call (520) 358-2221 or fill out our online form.",
    keywords: [
...
export function calculateAverageRating(testimonials: Testimonial[]): number {
  ...
  const sum = testimonials.reduce(
    (acc, testimonial) => acc + testimonial.fields.rating,
    0
  );
...
export const organizationSchema = {
  ...
  description:
    "Professional landscaping services in Fayetteville, Arkansas including lawn care, landscape design, hardscaping, irrigation, and tree care.",
  founder: {
    "@type": "Person",
    name: "Josh Cagle",
  },
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Professional weekly and bi-weekly lawn maintenance services",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Custom landscape design and professional installation services",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Stone patios, walkways, retaining walls, and outdoor living spaces",
        },
      },
    ],
  },
...
export const websiteSchema = {
  ...
  name: "Cagle's Landscaping & Restoration",
  description:
    "Professional landscaping services in Fayetteville, Arkansas and Northwest Arkansas",
  publisher: {
    "@id": `${baseUrl}/#organization`,
  },
  potentialAction: [
